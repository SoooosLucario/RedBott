...
class plant:
    ...
    def __init__(self, bot):
        ...
        self.gardeners = dataIO.load_json('data/plant/gardeners.json')
        self.plants = dataIO.load_json('data/plant/plants.json')
        self.products = dataIO.load_json('data/plant/products.json')
        self.defaults = dataIO.load_json('data/plant/defaults.json')
        self.badges = dataIO.load_json('data/plant/badges.json')
        self.notifications = dataIO.load_json('data/plant/notifications.json')
    ...
    async def _save_gardeners(self):
        ...
        dataIO.save_json('data/plant/gardeners.json', self.gardeners)
...
def check_folder():
    if not os.path.exists('data/plant'):
        print('Creating data/plant folder...')
        os.makedirs('data/plant')


def check_file():
    if not dataIO.is_valid_json('data/plant/gardeners.json'):
        print('Creating default gardeners.json...')
        dataIO.save_json('data/plant/gardeners.json', {})
